...
$sqlSP = mysql_query("SELECT ordine.CodOrd, ordine.Codice, ordine.FP, ordine.data, cliente.NomeCliente, nomeprod.NomeProd, 
			...
			<tr class="TestoPiccolo">
				...
				<td class="TabelleOrdini">Ora Part.</td>
                        ...
                        <tr class="<?=$rigaSP['Colore']?>" >
                                ...
                                <a href="cancellazione.php?idProdotto=<?=$rigaSP['CodProd']?>">

...
if (isset($_SESSION['Username']) && (
    ...
    header("location: OdL-operativa.php");
        } elseif (isset($_SESSION['Username']) && ($_SESSION['Username'] == 'spedi' || $_SESSION['Username'] == 'sleo')) {
            header("location: Tra-operativa.php");
    ...
    <tr>
        ...
        <tr>
            <td colspan="2" class="FondoImmagine">
                ...
                <li><a href="traframe.php">Visualizzazione STATO TRASPORTO</a> </li> 
                <br></br>
                <li>Anagrafica
                    <ul> 

...
<body>
<?
define ("POSIZIONE","Anagrafica - Prodotto");
define ("COLLEGAMENTO","InserisciSP.php");
...
<table style="width: 25%">
	...
	<tr class="TestoTitoli">
		<td colspan="3" class="style1">Inserisci Nuovo Prodotto<br/><br/></td>
	</tr>
	<tr>
		<td class="style3">Prodotto</td>
		<td class="style1">
		<form action="functionINSERT.php" method="post">
			<input name="DatoForm" type="text" />
                        <input name="id" type="hidden" value='Prodotto'>
		</td>
		<td class="style1"><input name="Button1" type="Submit" value="Inserisci" /></form></td>
	</tr>
</table>
<? include './anagrafiche/sp-modcanc.php'; ?>
</body>

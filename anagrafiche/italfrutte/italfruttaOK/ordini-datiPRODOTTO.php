<pre>
<b>PRODOTTO:</b>
inserisce/aggiunge prodotti all'ordine 
</pre>
<?php
...
if (isset($_POST['ordine']) || isset($_POST['Inserimento'])){
    ...
    if (isset($_POST['Cliente'])) $CodCliente=$Cliente=$_POST['Cliente'];
...
<?php   
    if ($esistenzaOI==1) echo "<p class='SistemaOK'>INSERIMENTO NUOVO ORDINE</p>";
    if ($esistenzaOI==2) echo "<p class='SistemaAlert'>INTEGRAZIONE ORDINE ESISTENTE</p>";
?>
<?php if ($esistenzaOI==1 || $esistenzaOI==2) : ?>
...
<? else : ?>
<p class="ErroreGrave" color="red">CODICE ORDINE NON DUPLICABILE</p>
<? endif; ?>

...
<body>
<?
define ("POSIZIONE","Anagrafica - Cliente");
define ("COLLEGAMENTO","InserisciCliente.php");
...
<table style="width: 25%">
	...
	<tr class="TestoTitoli">
		<td colspan="3" class="style1">Inserisci Nuovo Cliente<br/><br/></td>
	</tr>
	<tr>
		...
		<form action="functionINSERT.php" method="post">
			<input name="DatoForm" type="text" />
                        <input name="id" type="hidden" value='Cliente'>
		</td>
		<td class="style1"><input name="Button1" type="Submit" value="Inserisci" /></form></td>
	</tr>
</table>

<? include './anagrafiche/cliente-modcanc.php'; ?>
</body>

...
<title>Inserisci Nuovo Imballo</title>
<style type="text/css">
.style1 {
	text-align: center;
}
...
<body>
<?
define ("POSIZIONE","Anagrafica - Imballo");
define ("COLLEGAMENTO","InserisciImballo.php");
include_once 'percorso.php';
?>
<table style="width: 25%">
	<tr>
		<td style="width: 324px; height: 123px;"><img src="Risorse/ItalfruttaL2.jpg" /></td>
		<td class="style1" style="height: 123px" colspan="2"><span class="TestoTitoli">ItalFrutta <br/>tabella IMBALLO</span></td>
	</tr>

	<tr class="TestoTitoli">
		<td colspan="3" class="style1">Inserisci Nuovo Imballo<br/><br/></td>
	</tr>
	<tr>
		<td class="style3">Imballo</td>
		<td class="style1">
...
<? include './anagrafiche/imballo-modcanc.php'; ?>
</body>

...
<title>Inserisci Nuovo Pallet</title>
<style type="text/css">
.style1 {
	text-align: center;
}
...
<body>
<?
define ("POSIZIONE","Anagrafica - Pallet");
define ("COLLEGAMENTO","InserisciPallet.php");
...
<table style="width: 25%">
	<tr>
		...
		<td class="style1" style="height: 123px" colspan="2"><span class="TestoTitoli">ItalFrutta <br/>tabella pallet</span></td>
	</tr>

	<tr class="TestoTitoli">
		<td colspan="3" class="style1">Inserisci Nuovo Pallet<br/><br/></td>
	</tr>
	<tr>
		<td class="style3">Pallet</td>
		<td class="style1">
		<form action="functionINSERT.php" method="post">
			<input name="DatoForm" type="text" />
                        <input name="id" type="hidden" value='Pallet'>
		</td>
		<td class="style1"><input name="Button1" type="Submit" value="Inserisci" /></form></td>
	</tr>
</table>
<? include './anagrafiche/pallet-modcanc.php'; ?>
</body>

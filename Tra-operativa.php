...
<?php
    ...
    } elseif (isset($_POST['percorso']) && $_POST['percorso'] == 'updateTRA' && isset($_POST['btARRIVAT'])) {
        update_arrivato_testata_tra($_POST,($_POST['btARRIVAT'] ? 0 : 1));
    } elseif (isset($_POST['percorso']) && $_POST['percorso'] == 'updateTRA' && isset($_POST['btPARTITO'])) {
        update_colore_tra_totale($_POST,($_POST['rColore']=="Black") ? "B" : "Black");
    } elseif (isset($_POST['percorso']) && $_POST['percorso'] == 'updateTRA' && isset($_POST['btCARI'])) {
        update_colore_trariga($_POST,($_POST['rColore']=="Lilla" ? "B" : "Lilla")); 
    } 
?>
<table class="tblibera" style="width:100%">
<?
if ($sodlval > 1) {
    TraSelectOperativa2($dataform);
}
?>
</table>

...
<title>Inserisci Nuova Pezzatura</title>
<style type="text/css">
.style1 {
	text-align: center;
}
...
<body>
<?
define ("POSIZIONE","Anagrafica - Pezzatura");
define ("COLLEGAMENTO","InserisciPezzatura.php");
include_once 'percorso.php';
?>
<table style="width: 25%">
	<tr>
		<td style="width: 324px; height: 123px;"><img src="Risorse/ItalfruttaL2.jpg" /></td>
		<td class="style1" style="height: 123px" colspan="2"><span class="TestoTitoli">ItalFrutta <br/>tabella pezzatura</span></td>
	</tr>

	<tr class="TestoTitoli">
		<td colspan="3" class="style1">Inserisci Nuova Pezzatura<br/><br/></td>
	</tr>
	<tr>
		<td class="style3">Pezzatura</td>
		<td class="style1">
		<form action="functionINSERT.php" method="post">
			<input name="DatoForm" type="text" />
                        <input name="id" type="hidden" value='Pezzatura'>
		</td>
		<td class="style1"><input name="Button1" type="Submit" value="Inserisci" /></form></td>
	</tr>
</table>
<? include './anagrafiche/pezzatura-modcanc.php'; ?>
</body>
